...
public final class SearchTermParameter implements SearchParameter {
   ...
   */
  public SearchTermParameter(String searchfield, String searchvalue) throws IllegalArgumentException {
    if (searchfield == null)
  ...
  public Query toQuery() {
    if (this.isEmpty()) {
      System.err.println("This search query is empty!");
      return null;
    }
  ...
  public String toString() {
    return this._searchfield+":"+this._searchvalue;
  }
