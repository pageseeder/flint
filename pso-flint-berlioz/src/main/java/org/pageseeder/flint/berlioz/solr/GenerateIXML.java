 ...
 */
public final class GenerateIXML extends SolrIndexGenerator {
  ...
  public void process(SolrIndexMaster master, ContentRequest req, XMLWriter xml) throws BerliozException, IOException {
    ...
    File f = new File(master.getIndex().getContentLocation(), path);
    ...
    xml.attribute("template", FlintConfig.get().getIndexDefinitionFromIndexName(master.getName()).getTemplate().getName());
